...
#define GAP_DEVICE_NAME_STR                     "SmartMailBox" // Excluding null-terminate char
#define GAP_DEVICE_NAME_LEN                     (sizeof(GAP_DEVICE_NAME_STR)-1) // Excluding null-terminate char
